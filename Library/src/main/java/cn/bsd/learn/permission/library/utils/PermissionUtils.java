//package com.netease.permission.library.utils;
//
...
//     * @param context 上下文
//     * @param permission 权限
//     * @return 有权限返回true（6。0一下直接返回true）
...
//     * @return 如果有任一"不再询问"的权限返回true，反之返回false
//     */
...
//
//
package cn.bsd.learn.permission.library.utils;
